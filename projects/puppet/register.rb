...
project :name => 'puppet' do |puppet|
  ...
  puppet.on_version "*",             "create rpm package", "#{@project_dir}/template.spec"
  puppet.on_version "*",             "update yum repo",    "#{@artifacts_dir}/repos/rawhide"
  puppet.on_version "=",   "0.25.4", "update yum repo",    "#{@artifacts_dir}/repos/stable"
  puppet.on_version ">=",  "0.25.4", "update yum repo",    "#{@artifacts_dir}/repos/maintenance"
  puppet.on_version ">=",  "0.25.4", "update yum repo",    "#{@artifacts_dir}/repos/devel"
end
