...
project :name => 'ruby-activerecord' do |activerecord|
  ...
  activerecord.on_version "*",           "create rpm package", :spec => "#{@project_dir}/template.spec", :mock => @system_mock_env
  activerecord.on_version "*",           "update yum repo",    :repo => "#{@artifacts_dir}/repos/rawhide"
  activerecord.on_version "=",  "2.0.1", "update yum repo",    :repo => "#{@artifacts_dir}/repos/stable"
  activerecord.on_version "=",  "2.3.5", "update yum repo",    :repo => "#{@artifacts_dir}/repos/maintenance"
