...
project :name => 'rubygem-mongrel' do |mongrel|
  ...
  mongrel.on_version "*",           "create rpm package", :spec => "#{@project_dir}/template.spec", :mock => @system_mock_env
  mongrel.on_version "*",           "update yum repo",    :repo => "#{@artifacts_dir}/repos/rawhide"
  mongrel.on_version "=",  "1.1.5", "update yum repo",    :repo => "#{@artifacts_dir}/repos/stable"
  mongrel.on_version ">=", "1.2.0", "update yum repo",    :repo => "#{@artifacts_dir}/repos/maintenance"
